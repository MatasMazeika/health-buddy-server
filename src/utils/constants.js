...
export const CALORIES_NOT_PROVIDED = 'CALORIES_NOT_PROVIDED';
export const PROTEIN_NOT_PROVIDED = 'PROTEIN_NOT_PROVIDED';
export const FAT_NOT_PROVIDED = 'FAT_NOT_PROVIDED';
export const CARBS_NOT_PROVIDED = 'CARBS_NOT_PROVIDED';
